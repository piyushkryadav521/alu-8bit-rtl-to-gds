module alu_8bit (carry,
 ...
 sky130_fd_sc_hd__nand2_1 _121_ (.A(net7),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _122_ (.A(_022_),
    ...
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__nand2b_1 _123_ (.A_N(net14),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _124_ (.A(_025_),
    ...
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__a311o_1 _125_ (.A1(_114_),
    .A2(_120_),
    .A3(_011_),
    .B1(_020_),
    .C1(_026_),
 ...
 sky130_fd_sc_hd__nor2_1 _126_ (.A(_024_),
    ...
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__and2_1 _127_ (.A(_024_),
    .B(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__o22a_1 _128_ (.A1(net7),
    .A2(_065_),
    .B1(_023_),
    .B2(_064_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__a22o_1 _129_ (.A1(net8),
    .A2(_067_),
    .B1(_074_),
    .B2(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__a21o_1 _130_ (.A1(_058_),
    .A2(_022_),
    .B1(_031_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__o211a_1 _131_ (.A1(_073_),
    .A2(_024_),
    .B1(_030_),
    .C1(_076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__o31ai_1 _132_ (.A1(_061_),
    .A2(_028_),
    .A3(_029_),
    .B1(_033_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__o211a_1 _133_ (.A1(_114_),
    .A2(_115_),
    .B1(_007_),
    .C1(_113_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nor2_1 _134_ (.A(_008_),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__xor2_1 _135_ (.A(_024_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__o2bb2a_1 _136_ (.A1_N(_075_),
    .A2_N(_037_),
    .B1(_034_),
    .B2(_032_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _137_ (.A(net8),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__nand2_1 _138_ (.A(net8),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__nand2_1 _139_ (.A(_038_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31ai_2 _140_ (.A1(_008_),
    ...
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__xor2_1 _141_ (.A(_040_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__and2b_1 _142_ (.A_N(net15),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__o21ai_1 _143_ (.A1(_029_),
    .A2(_043_),
    .B1(_040_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__or3_1 _144_ (.A(_029_),
    .B(_040_),
    .C(_043_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__and3_1 _145_ (.A(_060_),
    .B(_044_),
    .C(_045_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__nor2_1 _146_ (.A(_064_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__a2bb2o_1 _147_ (.A1_N(_073_),
    .A2_N(_040_),
    .B1(_038_),
    .B2(_058_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__a2bb2o_1 _148_ (.A1_N(net8),
    .A2_N(_065_),
    .B1(_074_),
    .B2(net7),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__or4_1 _149_ (.A(_075_),
    .B(_047_),
    .C(_048_),
    .D(_049_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__o2bb2a_1 _150_ (.A1_N(_075_),
    .A2_N(_042_),
    .B1(_046_),
    .B2(_050_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__or4_1 _151_ (.A(net21),
    .B(net22),
    .C(net23),
    .D(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__or2_1 _152_ (.A(net25),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__nor4_1 _153_ (.A(net26),
    .B(net27),
    .C(net28),
    .D(_052_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(net29));
 sky130_fd_sc_hd__nand2b_1 _154_ (.A_N(net16),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__a21bo_1 _155_ (.A1(_038_),
    .A2(_041_),
    .B1_N(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__a32o_1 _156_ (.A1(_060_),
    .A2(_044_),
    .A3(_053_),
    .B1(_054_),
    .B2(_075_),
    ...
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__inv_2 _157_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__inv_2 _158_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__nand2_1 _159_ (.A(net31),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__nor2_2 _160_ (.A(net30),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__nand2_1 _161_ (.A(net1),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__nor3b_2 _162_ (.A(net30),
    .B(net31),
    .C_N(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__or3b_2 _163_ (.A(net30),
    .B(net31),
    .C_N(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__a221oi_1 _164_ (.A1(net1),
    .A2(net9),
    .B1(net30),
    .B2(net32),
    .C1(net31),
    ...
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__o22a_1 _165_ (.A1(net1),
    .A2(net9),
    .B1(_058_),
    .B2(_062_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__or3b_4 _166_ (.A(net30),
    .B(net32),
    .C_N(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__nand3b_4 _167_ (.A_N(net31),
    .B(net32),
    .C(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__o22ai_1 _168_ (.A1(_059_),
    .A2(_064_),
    .B1(_065_),
    .B2(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__and3_2 _169_ (.A(net30),
    .B(net31),
    .C(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__a211o_1 _170_ (.A1(net2),
    .A2(_067_),
    .B1(_066_),
    .C1(_063_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__nand2_1 _171_ (.A(net2),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__xnor2_2 _172_ (.A(net2),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__nand2b_1 _173_ (.A_N(net1),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nand2_1 _174_ (.A(_069_),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__or2_1 _175_ (.A(_069_),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__or3b_2 _176_ (.A(net31),
    .B(net32),
    .C_N(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__and3b_1 _177_ (.A_N(net32),
    .B(net31),
    .C(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__nor3_4 _178_ (.A(net19),
    .B(net18),
    .C(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__or3_2 _179_ (.A(net30),
    .B(net31),
    .C(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__o21a_1 _180_ (.A1(net2),
    .A2(net10),
    .B1(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__o22a_1 _181_ (.A1(net2),
    .A2(_065_),
    .B1(_068_),
    .B2(_064_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__a21bo_1 _182_ (.A1(net3),
    .A2(_067_),
    .B1_N(_078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__a2bb2o_1 _183_ (.A1_N(_069_),
    .A2_N(_073_),
    .B1(_074_),
    .B2(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__a311o_1 _184_ (.A1(_060_),
    .A2(_071_),
    .A3(_072_),
    .B1(_075_),
    .C1(_079_),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__xor2_1 _185_ (.A(_059_),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__o32a_1 _186_ (.A1(_077_),
    .A2(_080_),
    .A3(_081_),
    .B1(_082_),
    .B2(_076_),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__or2_1 _187_ (.A(net3),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__nand2_1 _188_ (.A(net3),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _189_ (.A(_083_),
    ...
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__o21ai_1 _190_ (.A1(_059_),
    .A2(_069_),
    .B1(_068_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__xnor2_1 _191_ (.A(_085_),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__and2b_1 _192_ (.A_N(net10),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__a21o_1 _193_ (.A1(_069_),
    .A2(_070_),
    .B1(_088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__nand2_1 _194_ (.A(_085_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__or2_1 _195_ (.A(_085_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__a22o_1 _196_ (.A1(net4),
    .A2(_067_),
    .B1(_074_),
    .B2(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__o22a_1 _197_ (.A1(net3),
    .A2(_065_),
    .B1(_073_),
    .B2(_085_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__o21ai_1 _198_ (.A1(_064_),
    .A2(_084_),
    .B1(_093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__a211o_1 _199_ (.A1(_058_),
    .A2(_083_),
    .B1(_092_),
    .C1(_075_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__a31o_1 _200_ (.A1(_060_),
    .A2(_090_),
    .A3(_091_),
    .B1(_095_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__o22a_1 _201_ (.A1(_076_),
    .A2(_087_),
    .B1(_094_),
    .B2(_096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__and2_1 _202_ (.A(net4),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__nand2_1 _203_ (.A(net4),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _204_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__nor2_1 _205_ (.A(_097_),
    .B(_099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__xnor2_2 _206_ (.A(net4),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__a21bo_1 _207_ (.A1(_083_),
    .A2(_086_),
    .B1_N(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__xnor2_1 _208_ (.A(_101_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__o32a_1 _209_ (.A1(net30),
    .A2(_057_),
    .A3(_099_),
    .B1(_101_),
    .B2(_073_),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__o2bb2a_1 _210_ (.A1_N(net3),
    .A2_N(_074_),
    .B1(_098_),
    .B2(_064_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__o2bb2a_1 _211_ (.A1_N(net5),
    .A2_N(_067_),
    .B1(_065_),
    .B2(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__nand3_1 _212_ (.A(_104_),
    .B(_105_),
    .C(_106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__o211a_1 _213_ (.A1(_055_),
    .A2(net11),
    .B1(_090_),
    .C1(_100_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__and3b_1 _214_ (.A_N(net11),
    .B(_101_),
    .C(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__a31o_1 _215_ (.A1(_085_),
    .A2(_089_),
    .A3(_101_),
    .B1(_061_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__nor3_1 _216_ (.A(_108_),
    .B(_109_),
    .C(_110_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__a211o_1 _217_ (.A1(_075_),
    .A2(_103_),
    .B1(_107_),
    .C1(_111_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__or2_1 _218_ (.A(net5),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__nand2_2 _219_ (.A(net5),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _220_ (.A(_112_),
    ...
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__a21oi_1 _221_ (.A1(_100_),
    .A2(_102_),
    .B1(_097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__or2_1 _222_ (.A(_114_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__nand2_1 _223_ (.A(_114_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__a21o_1 _224_ (.A1(_116_),
    .A2(_117_),
    .B1(_076_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _225_ (.A_N(net12),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a311o_1 _226_ (.A1(_085_),
    .A2(_089_),
    .A3(_101_),
    .B1(_109_),
    .C1(_119_),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__nand2_1 _227_ (.A(_114_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__o21a_1 _228_ (.A1(_114_),
    .A2(_120_),
    .B1(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and2_1 _229_ (.A(_000_),
    .B(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__nor2_1 _230_ (.A(net5),
    .B(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__a221o_1 _231_ (.A1(net6),
    .A2(_067_),
    .B1(_112_),
    .B2(_058_),
    .C1(_003_),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__o22ai_1 _232_ (.A1(_064_),
    .A2(_113_),
    .B1(_114_),
    .B2(_073_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__a211o_1 _233_ (.A1(net4),
    .A2(_074_),
    .B1(_075_),
    .C1(_005_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__o31a_1 _234_ (.A1(_002_),
    .A2(_004_),
    .A3(_006_),
    .B1(_118_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__nand2_1 _235_ (.A(net6),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _236_ (.A(net6),
    ...
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__or2_1 _237_ (.A(net6),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__and2_1 _238_ (.A(_007_),
    .B(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nand2_1 _239_ (.A(_007_),
    .B(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__a21oi_1 _240_ (.A1(_113_),
    .A2(_116_),
    .B1(_011_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__a31o_1 _241_ (.A1(_113_),
    .A2(_116_),
    .A3(_011_),
    .B1(_076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__o2bb2a_1 _242_ (.A1_N(_058_),
    .A2_N(_009_),
    .B1(_011_),
    .B2(_073_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__o2bb2a_1 _243_ (.A1_N(net5),
    .A2_N(_074_),
    .B1(_007_),
    .B2(_064_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__o2bb2a_1 _244_ (.A1_N(net7),
    .A2_N(_067_),
    .B1(_065_),
    .B2(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__and3_1 _245_ (.A(_014_),
    .B(_015_),
    .C(_016_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__o211a_1 _246_ (.A1(_056_),
    .A2(net13),
    .B1(_000_),
    .C1(_010_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _247_ (.A(_000_),
    ...
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__and3b_1 _248_ (.A_N(net13),
    .B(_011_),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__or4_1 _249_ (.A(_061_),
    .B(_018_),
    .C(_019_),
    .D(_020_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__o211ai_1 _250_ (.A1(_012_),
    .A2(_013_),
    .B1(_017_),
    .C1(_021_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(net26));
 sky130_fd_sc_hd__or2_1 _251_ (.A(net7),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 input17 (.A(opcode[0]),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__buf_1 input18 (.A(opcode[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__buf_1 input19 (.A(opcode[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output29 (.A(net29),
    ...
    .VPWR(VPWR),
    .X(zero));
 sky130_fd_sc_hd__buf_2 fanout30 (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkbuf_2 fanout31 (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__buf_2 fanout32 (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_2 FILLER_6_101 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_7_7 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_13_15 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_13_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_15_57 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_15_80 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
